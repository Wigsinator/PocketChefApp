...
As a user, I want to be able to view my user profile so that I can see my username, first name, last name, email, phone number, password, and all the recipes I have created.
...
### **LION-69 Add a Recipe to Firebase**
- Priority: Highest
- Points: 8

As a user, I want to be able to access and view my recipes after I create them on the app. 

**Criteria of Satisfaction:**
1. When a recipe is created, the appropriate information is added to the Firebase Database.
2. When viewing another recipe, the information should be pulled from the relevant entry stored in the database.

### **LION-75 Authentication on Login Screen**
- Priority: Medium
- Points: 3

As a user, I would like to be able to login into my account in order to retrieve information relevant to me. 

**Criteria of Satisfaction:**
1. Login successful only with correct combination of username and password 
2. Upon login, the app should recognize the user and display information relevant to the user. 

### **LION-85 Use of navigation buttons to change screens**
- Priority: Medium
- Points: 3

As a user, I want to be able to use the navigation buttons to move between different screens 

**Criteria of Satisfaction:**
1. Navigation buttons should be clickable & take users to the appropriate screens 
